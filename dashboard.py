                ...
                html.Div(
                    html.Div([
                        html.Div([
                            ...
                            html.Div([
                                html.Div("김여정", className="persona-1-2-1 response-title"),
...
app = Dash(__name__, title="Business Dashboard", assets_external_path=".")
server = app.server

app.layout = html.Div([
    html.Div(
        html.Img(src="assets/logo.png", id="logo-img")
    , id="logo"),

    html.Header([
        html.H3("Business Dashboard", id="header-text"),
